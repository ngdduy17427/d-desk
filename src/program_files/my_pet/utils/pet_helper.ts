...
import { PetOption, PetOptions, PetSelectOption } from "../@type";

export const PetSelectOptions: Map<PetOption, PetSelectOption> = new Map();

PetSelectOptions.set(PetOptions.WHITE_CAT, {
  value: PetOptions.WHITE_CAT,
  label: "White Cat",
...
PetSelectOptions.set(PetOptions.YELLOW_CAT, {
  value: PetOptions.YELLOW_CAT,
  label: "Yellow Cat",
...
PetSelectOptions.set(PetOptions.BROWN_CAT, {
  value: PetOptions.BROWN_CAT,
  label: "Brown Cat",
...
PetSelectOptions.set(PetOptions.BLACK_CAT, {
  value: PetOptions.BLACK_CAT,
  label: "Black Cat",
