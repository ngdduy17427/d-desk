...
export function updateEntitySprite(entity: PlayerEntity): void {
  if (
...
export function updateEntitySpriteAnimation(entity: GameEntity, delta: number): void {
  ...
  entity.animation.frameX =
    entity.animation.spriteSheetState[entity.animation.currentFrameIndex][0];
  entity.animation.frameY =
    entity.animation.spriteSheetState[entity.animation.currentFrameIndex][1];
}

export function updateEntityPosition(entity: PlayerEntity, delta: number): void {
...
export function reorderGameObjectsByY(gameEntities: Array<GameEntity>): Array<GameEntity> {
