...
export const AppThemeOptions: Array<AppThemeOption> = [
...
export const AppCursorOptions: Array<AppCursorOption> = [
...
export const AppBackgroundOptions: Array<AppBackgroundOption> = [
  {
    value: 'bg-1',
    label: 'Forest 1',
    image: `${process.env.NEXT_PUBLIC_BASE_URL}/images/background/bg-1.png`,
  },
  {
    value: 'bg-2',
    label: 'Forest 2',
    image: `${process.env.NEXT_PUBLIC_BASE_URL}/images/background/bg-2.png`,
  },
]
